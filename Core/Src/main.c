...
osSemaphoreId epapBusySemHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* definition and creation of epapBusySem */
  osSemaphoreDef(epapBusySem);
  epapBusySemHandle = osSemaphoreCreate(osSemaphore(epapBusySem), 1);
  ...
  osThreadDef(mainTask, runMainTask, osPriorityNormal, 0, 256);
